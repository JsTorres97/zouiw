                  ...
                  <div class="col-lg-6">
                    <div class="card">
                          ...
                          <div id="pay-invoice">
                              <div class="card-body">
                                  <div class="card-title">
                                      <h3 class="text-center">Baja de sucursal</h3>
                                  </div>
                                  <hr>
                                  <!---->
                            ...
                            <div class="col-sm-12 text-center">
                                <button type="submit" name="eliminar" class="btn btn-primary"><i class="fa fa-save"></i> Borrar sucursal</button>
                            </div>
                        </form>
                        <?php
                        $control=0;
                        ...
                        if(isset($_POST['eliminar'])){
                            $id = $_POST['clientes'];
                            if($sql=mysqli_query($con, "DELETE  FROM Sucursal WHERE ID='$id'")){
                                $control=1;
                            }else{
                                $control=0;
                            }
                  ...
                  <div class="col-lg-6">
                    <div class="card">
                      ...
                      if($control==1){
                          ...
                          <strong>Sucursal borrada con exito</strong>
                        </div>';
                      }else{
                          echo'';
                      }
