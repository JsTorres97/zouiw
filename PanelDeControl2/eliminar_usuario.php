                  ...
                  <div class="col-lg-6">
                    <div class="card">
                          ...
                          <div id="pay-invoice">
                              <div class="card-body">
                                  <div class="card-title">
                                      <h3 class="text-center">Baja de usuario</h3>
                                  </div>
                                  <hr>
                                  <!---->
                            ...
                            <div class="col-sm-12 text-center">
                                <button type="submit" name="eliminar" class="btn btn-primary"><i class="fa fa-save"></i> Borrar usuario</button>
                            </div>
                        </form>
                        <?php
                        $control=0;
                        ...
                        if(isset($_POST['eliminar'])){
                            $id = $_POST['usuario'];
                            mysqli_query($con,"SET NAMES 'utf8'");
                            if($sql=mysqli_query($con, "DELETE  FROM Usuario WHERE ID='$id'")){
                                $control=1;
                            }else{
                                $control=0;
                            }
