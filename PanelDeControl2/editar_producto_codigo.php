            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Editar producto por código de barras</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
        ...
        <?php
           $control=0;
            if(isset($_POST['actualizarprod'])){
                ...
                $referenciaa = $_POST['referencia'];
                
               

                
                if($actualizar = mysqli_query($con,"UPDATE Producto SET CODIGO_BARRAS = '$codigoa', REFERENCIA='$referenciaa', PRODUCTO = '$noma', COLOR = '$colora', CANTIDAD = '$cantidada', PCZ = '$pcza', PCZIVA = '$pczivaa', PPZ = '$ppza', PRECIO_MAYORISTA = '$mayoristaa', PRECIO_SOCIOS = '$sociosa', PRECIO_EMPLEADOS = '$empleadosa' WHERE ID= '$id'")){
                    $control=1;
                }else{
                    $control=0;
                }
                              ...
                              <div class="card-body">
                                  ...
                                  <hr>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input id="Referencia" name="referencia" type="text" class="form-control cc-number identified visa" value="<?php echo $referencia; ?>" data-val="true" data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number" autocomplete="cc-number">
