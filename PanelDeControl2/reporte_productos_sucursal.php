            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Reporte de productos por sucursal</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                        ...
                        <div class="card-body">
                          ...
                          <div id="pay-invoice">
                              <div class="card-body">
                                  ...
                                  <div align="center">
                                  <button type="button" class="btn btn-primary" OnClick="todos()"><i class="fa fa-shopping-basket"></i>&nbsp; Todos los productos</button>
                                  <button type="button" class="btn btn-primary" OnClick="enstock()"><i class="fa fa-shopping-basket"></i>&nbsp; Productos en stock</button><br><br>
                                  <button type="button" class="btn btn-primary" OnClick="sinstock()"><i class="fa fa-shopping-basket"></i>&nbsp; Productos sin stock</button>
                                  <hr>
                                  </div>
                                  </div>
                            </div>
