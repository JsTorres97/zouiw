            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Eliminar producto por referencia</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                  ...
                  <div class="col-lg-6">
                    <div class="card">
                          ...
                          <div id="pay-invoice">
                              <div class="card-body">
                                  <div class="card-title">
                                      <h3 class="text-center">Eliminar producto por referencia</h3>
                                  </div>
                                  <hr>
                                  <!---->
                                    ...
                                    <label for="barras" class="control-label mb-1">Sucursal</label>
                                        ...
                                        ?>
                                         ...
                                         <div class="form-group">
                                          ...
                                          <input id="referencia" name="referencia" type="text" class="form-control cc-number identified visa" data-val="true" data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number" autocomplete="cc-number">
                        ...
                        if(isset($_POST['eliminar'])){
                            ...
                            mysqli_query($con,"SET NAMES 'utf8'");
                            if($sql=mysqli_query($con, "DELETE  FROM producto WHERE SUCURSAL='$sucursal' AND REFERENCIA='$ref'")){
                                $control=1;
                            }else{
                                $control=0;
                            }
